...
#include "filter.h"
  ...
  #define PID_YAW_INTEGRATION_LIMIT     360

#define PID_XPOSITION_INTEGRATION_LIMIT 2.0
#define PID_YPOSITION_INTEGRATION_LIMIT 2.0

#define PID_XVELOCITY_INTEGRATION_LIMIT 1.0
#define PID_YVELOCITY_INTEGRATION_LIMIT 1.0
